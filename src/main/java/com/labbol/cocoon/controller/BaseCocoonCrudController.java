 ...
 * @since 2.0
 */
public abstract class BaseCocoonCrudController<M> extends BaseCocoonController {
	 ...
	 * @throws Exception 操作异常
	 */
	protected String beforeDeleteModel(String deleteIds) throws Exception {
		return deleteIds;
	}
	 ...
	 * @throws Exception 操作异常
	 */
	protected void afterQueryModel(M model, PageInfo<?> pageInfo) throws Exception {
	 ...
	 * @throws Exception 操作异常
	 */
	protected void beforeRetrieveModel(M model) throws Exception {
	 ...
	 * @throws Exception 操作异常
	 */
	protected void afterRetrieveModel(M bindModel, M model) throws Exception {
	...
	protected Class<M> getModelClass() {
		Map<TypeVariable<?>, Type> typeArguments = TypeUtils.getTypeArguments(getClass(),
				BaseCocoonCrudController.class);
