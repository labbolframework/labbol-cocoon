...
public class ProjectPathSetServletContextListener implements ServletContextListener {
	...
	@Value("${" + Cocoon.COCOON_PROPERTIES_PREFIX + ".staticResourcesServiceName:}")
	private String staticResourcesServiceName;

	@Value("${" + Cocoon.COCOON_PROPERTIES_PREFIX + ".thisProjectServiceName:}")
	private String thisProjectServiceName;

	@Value("${" + Cocoon.COCOON_PROPERTIES_PREFIX + ".staticResourcesRootPath:}")
	private String staticResourcesRootPath;

	@Value("${" + Cocoon.COCOON_PROPERTIES_PREFIX + ".thisProjectRootPath:}")
